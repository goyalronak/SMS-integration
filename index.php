...
echo '<div class="content"><form method="post"><br>
 Enter Mobile Number <br>
<input type="text" class="w3-input" name="uid" value="'.$uid.'"/><br>
Enter your Password <br>
<input type="password" class="w3-input" name="pwd" value="'.$pwd.'"/><br/>
Enter Receipt Number<br>
<input type="text" class="w3-input" name="to" value="'.$to.'"/><br/>
Message <br>
<textarea class="w3-input" name="msg"></textarea><br/>
<input type="submit" class="w3-btn w3-white w3-border w3-round" value="Send"/></form><br>
</div>';
include('foot.php');
?>